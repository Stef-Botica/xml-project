...
To view this document as a web page, the file "home.html" using Mozilla Firefox or Safari. This can be accomplished by either dragging the file into the browser window or by right clicking the file and selecting "Open With" to choose Firefox or Safari as the program.

Please note that this will not work with Internet Explorer or more recent versions of Chrome. Firefox or Safari MUST be used to view the content as a website.
